...
var UserService = (function () {
    ...
    UserService.prototype.getAll = function () {
        return this.http.get(this.baseUrl + '/users', this.jwt()).map(function (response) { return response.json(); });
    };
    UserService.prototype.getCurrentUser = function (id) {
        return this.http.get(this.baseUrl + '/me/', this.jwt()).map(function (response) { return response.json(); });
    };
